...
<html lang="pt-BR">
    <head>
        <meta charset="UTF-8">
        <title>Encripto - Administrador</title>
    ...
    <body>
        <main class="profile-section">
            <div class="profile-container">
                    <div class="edit">
                        <a href="novo_usuario.jsp" class="botao-finalizar">Novo Usuário</a>
                        <a href="novo_produto.jsp" class="botao-finalizar">Novo Produto</a>
                    </div>
                </div>
        </main>
